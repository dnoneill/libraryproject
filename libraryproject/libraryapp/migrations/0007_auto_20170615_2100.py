...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('libraryapp', '0006_auto_20170615_2100'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='loans',
            name='borrowed_from',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='borrowed_from', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='loans',
            name='borrower',
